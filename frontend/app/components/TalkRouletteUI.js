...
import { Dices, Clock, RotateCcw, Edit } from 'lucide-react';
...
<<<<<<< HEAD
        {isEditing ? (
          ...
          <>
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-inner border-2 border-blue-200 h-48 flex items-center justify-center relative">
              <p className="text-lg sm:text-xl md:text-2xl font-bold text-center text-gray-800 leading-relaxed px-2">
                {state === 'spinning' 
